    ...
    return (
        <div className='banner'>
            ...
            <div className="posts-container">
                ...
                <div className="post-item">
                    <img className="blog-image" src="/Blog-2.webp" alt="imagem blog" />
                ...
                <div className="post-item">
                    <img className="blog-image" src="/Blog-3.webp" alt="imagem blog" />
                ...
                <div className="post-item">
                    <img className="blog-image" src="/Blog-4.webp" alt="imagem blog" />
