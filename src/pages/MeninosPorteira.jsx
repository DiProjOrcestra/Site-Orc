...
function MeninosPorteira() {
  return (
    <main className="project">
      ...
      <img className="project-image" src={meninosPortImg} alt="Projeto Meninos da Porteira"/>

      <h1 className="project-title">Meninos da Porteira</h1>

      <ProjectSection title="O que foi o projeto?">
        <p>
          O projeto Meninos da Porteiro foi um projeto encomedado pela AD&M, Empresa Júnior de Admnistração 
          da Universidade de Brasília, eles tem uma missão de impactar histórias e transformar realidades com a 
          inovação e gestão. A mesma procurou a Orc’estra Gamificação com o objetivo de melhoria em: permanência 
          dos membros, conhecimento de oportunidades, senso de liderança e propósito pessoal dos membros, ambos 
          de forma gamificada.
         </p>
          <p>
            Dentre os problemas a serem trabalhados na consultoria foram elencados a baixa permanência dos membros, 
            na qual a alta rotação afetava o planejamento estratégico da empresa.
          </p>
          <p>
            Foi visado o problema de pouco conhecimento das oportunidades oferecidas dentro da empresa, tendo a 
            consequência de um baixo senso de liderança, afetando o propósito pessoal do membro, que se sente desmotivado 
            e o problema de baixa permanência se repete.
          </p>
...
export default MeninosPorteira;